declare module "minecraft-bedrock-server" {
  ...
  function startServer(version, onStart, options: { path: string }): Promise<ChildProcess>

  // Starts the server and waits
  function startServerAndWait(version, withTimeout, options: { path: string }): Promise<ChildProcess>
}
